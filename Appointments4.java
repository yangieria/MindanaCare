...
public class Appointments4 {
    ...
    private static JPanel createConfirmedDetailsCard() {
        ...
        URL iconURL = Appointments4.class.getResource("About.png");
        if (iconURL != null) {
        ...
        finishBtn.addActionListener(e -> {
            ...
            if (!upcoming.isEmpty()) {
                Appointment latest = upcoming.get(upcoming.size() - 1);
                receipt += "Doctor   : " + latest.getDoctorName() + "\n"
            ...
            JOptionPane.showMessageDialog(null, receipt, "Appointment Confirmed", JOptionPane.INFORMATION_MESSAGE);
            AppointmentsMainPanel.showStep("STEP1");
            MindanaCare.loadPage(UserDashboard.createPanel());
        });

        card.add(finishBtn, BorderLayout.SOUTH);
        return card;
    }
